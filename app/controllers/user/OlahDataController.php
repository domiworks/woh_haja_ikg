...
class OlahDataController extends BaseController {
	...
	{	
		...
		return View::make('pages.__user.__olah.kebaktian',
			compact('list_jenis_kegiatan', 'list_pembicara'));		
	}		
	...
	public function view_anggota()
	{
		...
		return View::make('pages.__user.__olah.anggota', 
			compact('list_gereja','list_wilayah','list_gol_darah','list_pendidikan','list_pekerjaan','list_etnis','list_role'));
	}	
	...
	{		
		...
		return View::make('pages.__user.__olah.baptis', 
			compact('list_pembaptis','list_jenis_baptis','list_gereja','list_jemaat'));		
	}
	...
	{		
		...
		return View::make('pages.__user.__olah.atestasi', 
			compact('list_jenis_atestasi','list_jemaat','list_gereja'));		
	}
	...
	{	
		...
		return View::make('pages.__user.__olah.pernikahan', 
				compact('list_pendeta','list_jemaat_pria','list_jemaat_wanita','list_gereja'));				
	}
	...
	{			
		...
		// 	compact('list_anggota'));		
		return View::make('pages.__user.__olah.kedukaan', 
			compact('list_anggota'));		
	}
	...
	{	
		...
		return View::make('pages.__user.__olah.dkh', 
			compact('list_jemaat', 'list_jenis_dkh'));
	...
	public function edit_anggota()
	{
		...
		*/
		...
		$anggota->status_anggota = Input::get('status_anggota');
