	...
	<div class="container-fluid" style="background-color: white;">		<!--#FFFF19-->
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav nav-pills">
				<li><a href="{{URL::to('/user/inputdata_kebaktian')}}"><span class="glyphicon glyphicon-plus-sign" style="color:green; margin-right:10px;"></span>Input Data</a></li>
				<li>
					<div 
						style="height:40px; 
								width: 1px; 
				...
				<li><a href="{{URL::to('/user/olahdata_kebaktian')}}"><span class="glyphicon glyphicon-edit" style="color:orange; margin-right:10px;"></span>Olah Data</a></li>
				<li>
					<div 
						style="height:40px; 
								width: 1px; 
