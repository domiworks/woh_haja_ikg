...
@include('pages.__admin.__olah.popup_edit_atestasi')
@include('pages.__admin.__olah.popup_delete_warning_atestasi')
@include('pages.__popup_video.popup_video_olah_atestasi')
