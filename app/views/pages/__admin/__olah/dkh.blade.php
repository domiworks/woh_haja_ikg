					...
					<div class="panel-body">
						<form class="form-horizontal">								
							<div class="pull-right" style="position:relative;">
								...
								<input type="button" value="Help ?" class="btn btn-danger" data-toggle="modal" data-target=".popup_video_olah_dkh" />
							</div>
...
//eksport data dkh
	$('body').on('click', '#f_export_filtered_dkh', function(){
		...
		window.open("{{URL('admin/export_filtered_dkh')}}/"+						
						$no_dkh+"/"+
						$nama_jemaat+"/"+
						$jenis_dkh+"/"+
						$tanggal_awal+"/"+						
...
@include('pages.__admin.__olah.popup_edit_dkh')
@include('pages.__admin.__olah.popup_delete_warning_dkh')
@include('pages.__popup_video.popup_video_olah_dkh')
