<div class="modal fade popup_delete_warning_jenis_atestasi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
	$('body').on('click', '.okDelete', function(){
		...
		$.ajax({
			type: 'DELETE',
			url: "{{URL('superadmin/delete_jenis_atestasi')}}",
			data : {
				'json_data' : json_data				
			},
