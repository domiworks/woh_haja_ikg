					...
					<div class="panel-body">
						<form class="form-horizontal">	
							...
							<div class="pull-right" style="position:relative;">
								<input type="button" value="Help ?" id="f_video_input_anggota" class="btn btn-danger" data-toggle="modal" data-target=".popup_video_input_anggota" />
							</div>
							<div class="form-group">
								<label class="col-xs-4 control-label">
									Nama Depan
							...
							<div class="form-group">
								<div class="col-xs-6 col-xs-push-5">
									...
									<input type="button" id="f_post_anggota" class="btn btn-success" value="Simpan Data Anggota" disabled=true />
									 @else 
									<input type="button" id="f_post_anggota" class="btn btn-success" value="Simpan Data Anggota" data-toggle="modal" data-target=".popup_confirm_warning_anggota" />
									 @endif 
								</div>
							</div>
						</form>	
...
@include('pages.__user.__input.popup_confirm_warning_anggota')
@include('pages.__popup_video.popup_video_input_anggota')
