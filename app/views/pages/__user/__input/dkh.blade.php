					...
					<div class="panel-body">
						<form class="form-horizontal">
							<div class="pull-right" style="position:relative;">
								<input type="button" value="Help ?" id="f_video_input_dkh" class="btn btn-danger" data-toggle="modal" data-target=".popup_video_input_dkh" />
							</div>
...
@include('pages.__user.__input.popup_confirm_warning_dkh')
@include('pages.__popup_video.popup_video_input_dkh')
