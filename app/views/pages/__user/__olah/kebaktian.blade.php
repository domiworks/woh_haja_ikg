					...
					<div class="panel-body">
						<form class="form-horizontal">
							<div class="pull-right" style="position:relative;">
								...
								<input type="button" value="Help ?" id="f_video_olah_kebaktian" class="btn btn-danger" data-toggle="modal" data-target=".popup_video_olah_kebaktian" />
							</div>
...
<script>
	...
	$('body').on('click', '#f_export_filtered_kebaktian', function(){
		...
		window.open("{{URL('user/export_filtered_kegiatan')}}/"+
						$nama_kebaktian+"/"+
						$nama_pendeta+"/"+
						$tanggal_awal+"/"+
						$tanggal_akhir+"/"+
	...
	$('body').on('click', '.detailButton', function(){
		...
		else
		{
			...
			$('#f_edit_check_kebaktian_lain').val(0);
			$('#f_edit_check_kebaktian_lain').prop('checked', false);				
...
@include('pages.__user.__olah.popup_edit_kebaktian')
@include('pages.__user.__olah.popup_delete_warning_kebaktian')
@include('pages.__popup_video.popup_video_olah_kebaktian')
