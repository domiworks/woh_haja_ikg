					...
					<div class="panel-body">
						<form class="form-horizontal">	
							<div class="pull-right" style="position:relative;">
								...
								<input type="button" value="Help ?" id="f_video_olah_pernikahan" class="btn btn-danger" data-toggle="modal" data-target=".popup_video_olah_pernikahan" />
							</div>
...
<script>
	...
	$('body').on('click', '#f_export_filtered_pernikahan', function(){
		...
		window.open("{{URL('user/export_filtered_pernikahan')}}/"+
						$no_pernikahan+"/"+						
						$tanggal_awal+"/"+					
						$tanggal_akhir+"/"+					
						$id_pendeta+"/"+					
...
@include('pages.__user.__olah.popup_edit_pernikahan')
@include('pages.__user.__olah.popup_delete_warning_pernikahan')
