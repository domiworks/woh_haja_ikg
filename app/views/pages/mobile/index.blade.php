...
@section('content')	
<section class="s_left_display" style="">
	<div class="container-fluid"> 
		<div class="row">
			<div class="s_sidebar_area s_sidebar_lv_0" style="background-color: #fa0;">	
				<ul class="list-unstyled">
					<li>
						<a href="javascript:void(0)">Johna</a>
					</li>
					<li>
						<a href="javascript:void(0)">Johnb</a>
					</li>
					<li>
						<a href="javascript:void(0)">Johnc</a>
					</li>
					<li>
						<a href="javascript:void(0)">John1</a>
					</li>
					<li>
						<a href="javascript:void(0)">John3</a>
					</li>
					<li>
						<a href="javascript:void(0)">John4</a>
					</li>
					<li>
						<a href="javascript:void(0)">Johna</a>
					</li>
				...
				<div class="s_sidebar_lv_1 hidden" style="background-color: #0fa;">	
			...
			<div class="s_sidebar_close_area"  style="background-color: rgba(17,34,51,0.5);">	
				&nbsp;				
			</div>		
		</div>
	</div>
...
<section class="s_middle_display" style="background-color: #fc0;">
	<nav class="navbar navbar-default" role="navigation" style="border: 0px;">
		<div class="" style="text-align: center;">
			<a href="javascript:void()" class="f_side_bar_tutup hidden pull-left" style="line-height:48px; font-size: 1.4em;">	
				<span class="cusicon_menu"></span>	
			</a>						
			<a href="javascript:void()" class="f_side_bar_buka pull-left" style="line-height:48px; font-size: 1.4em;">	
				<span class="cusicon_menu"></span>						
			</a>	
			<span style="line-height: 48px; text-transform: uppercase;">
				FRUNK
			</span>
			<a href="javascript:void()" id="f_add_new_order" class="pull-right" style="line-height:48px; font-size: 1.4em;">	
				<span class="glyphicon glyphicon-plus-sign"></span>						
			</a>	
		</div>
	</nav>
	<!--<span  style="display: block; height: 48px; width: 100%; ">
	</span>-->
