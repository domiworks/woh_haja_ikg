...
<div class="s_content">
	<table border="0" style="width:450px;">					
		<tr>						
			...
			<td>:</td>
			<td><span class="f_front">{{array_get($data, 'data')->no_jemaat}}</span>
			<span class="f_back"><input type="text" id="f_up_no_jemaat" value="{{array_get($data, 'data')->no_jemaat}}" /></span></td>
		</tr>
		<tr>						
